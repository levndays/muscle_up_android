  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'user-not-found':
        case 'wrong-password':
          newErrorMessage = loc.loginPageErrorInvalidCredential;
          break;
        case 'email-already-in-use':
          newErrorMessage = 'This email is already taken. Please try another or sign in.';
          break;
        default:
          newErrorMessage = e.message ?? loc.loginPageErrorAuthDefault;
      }
      if(mounted) setState(() => _errorMessage = newErrorMessage);
      // ===== UPDATED BLOCK END =====
